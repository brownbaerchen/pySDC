...
parser.add_argument("--frameRate", "-r", default=20, type=int, help="frame rate used for the video")
...
if args.noClip:
    ...
    display.AmbientColor = [1, 1, 1]#[0.7019607843137254, 0.7019607843137254, 0.7019607843137254]
    display.DiffuseColor = [1, 1, 1]#[0.7019607843137254, 0.7019607843137254, 0.7019607843137254]
...
buoyancyLUT.ApplyPreset('Cool to Warm', True)
display.RescaleTransferFunctionToDataRange(True, False)
