...
def plot_Nu_over_time_Ra1e9():  # pragma: no cover
    ...
    plot_Nu(res, [0.0003], 'RBC3DG4R4SDC23Ra1e9', ref_data, Nu_axs[1], 'SDC23', converged_from)
    plot_Nu(res, [0.0003], 'RBC3DG4R4RKRa1e9', ref_data, Nu_axs[2], 'RK443', converged_from)
